...
<body>
    ...
    <div class="container">
        ...
        <form action="upload.php" method="POST" enctype="multipart/form-data">
            ...
            <label for="upload">room_size</label>
        ...
        <?php 
            $result = $conn->query("SELECT * FROM book_room3");
            $result->execute();
            ...
            if ($imgData) {
                ...
                foreach($imgData as $img) {
                    ...
                    echo '<img class="img-thumbnail" src="data:image/jpeg;base64,' . base64_encode($img['image_data']) . '" alt="Uploaded image" style="width: 100%;" />';
                    echo "</div>";
                }
                echo "</div>";
            } else {
